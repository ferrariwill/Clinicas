...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/permissoes-tela": {
            "post": {
                ...
                "tags": [
                    "Admin - Permissões de Tela"
                ],
                "summary": "Associar tela a tipo de usuário",
                "parameters": [
                    {
                        "description": "tipo_usuario_id e tela_id",
                        "name": "permissao",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/permissoes-tela/tela/{tela_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/permissoes-tela/tipo-usuario/{tipo_usuario_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/permissoes-tela/verificar/{tipo_usuario_id}/{tela_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/permissoes-tela/{tipo_usuario_id}/{tela_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/admin/tipos-usuario": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dados do tipo de usu?rio",
                        "name": "tipo_usuario",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/admin/tipos-usuario/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID do tipo de usu?rio",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/admin/tipos-usuario/{id}/reativar": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/controllers.ProntuarioRegistroSwagger"
                            }
                        }
                    }
                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.CriarProntuarioRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.AtualizarProntuarioRequest"
                        }
                    }
                ],
                "responses": {}
        ...
        "/dashboard/metricas-operacionais": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Último dia inclusivo do período (YYYY-MM-DD)",
                        "name": "fim",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.MetricasOperacionaisSwagger"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "controllers.AtualizarProntuarioRequest": {
            "type": "object",
            "required": [
                "conteudo",
                "titulo"
        ...
        "controllers.CriarProntuarioRequest": {
            "type": "object",
            "required": [
                "conteudo",
                "paciente_id",
        ...
        "controllers.MetricasOperacionaisSwagger": {
            "type": "object",
            "properties": {
                "agendamentos_considerados": {
                    "type": "integer",
                    "example": 120
                },
                "faturamento": {
        ...
        "controllers.ProntuarioRegistroSwagger": {
            "type": "object",
            "properties": {
                "clinica_id": {
                    "type": "integer",
