...
// MetricasOperacionaisResponse agrupa faturamento e absenteísmo (no-show).
type MetricasOperacionaisResponse struct {
	PeriodoInicio          string  `json:"periodo_inicio"`
	PeriodoFim             string  `json:"periodo_fim"`
	Faturamento            float64 `json:"faturamento"`
	AgendamentosConsiderados int `json:"agendamentos_considerados"`
	TotalFaltas            int     `json:"total_faltas"`
	TaxaNoShowPercentual   float64 `json:"taxa_no_show_percentual"`
}
